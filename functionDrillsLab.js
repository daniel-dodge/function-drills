...
let nameGreeting = nameCheck("Bryaasdv")
...
let colorRating = faveColorFinder("redd")
...
function theEliminator (contestant, loser){
  for (let i = 0; i < contestant.length; i++){
    if (contestant[i].includes(loser)){
...
coolFunction("jdasiojfiodsjdsf dijfo JIfOf dfkj")
////////////////// PROBLEM 12 ////////////////////
/*
...
let emailValidator = emailCheck("dlkajlkjlks  @  ")
...
function frog2(gold){
  ...
  let finalFrogs2 = gold/ 3
  return finalFrogs2
  }
  let totalFrogs2 = frog2(28)
...
let finalFrogs = (gold - remainder) / 3
return finalFrogs
}
let totalFrogs = frog(27)
